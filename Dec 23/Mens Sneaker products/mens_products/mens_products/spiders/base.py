    ...
    def insert_products_product(self, item, brand_id, category_id):
        ...
        try:
            ...
            columns = ['name', 'description', 'release_date', 'product_code', 'colorway', 'main_color', 'brand_id',
                       'category_id', 'product_url', 'published_date']
            values = (
            product_name, description, release_date, product_code, colorway, main_color, brand_id, category_id,
            product_url, published_date)
